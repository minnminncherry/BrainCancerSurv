...
def _process_args():
    ...
    parser.add_argument("--xgb_n_estimators", type=int, default=300, help="Number of trees for XGBoost.")
    parser.add_argument("--xgb_max_depth", type=int, default=6, help="Maximum tree depth for XGBoost.")
    parser.add_argument("--xgb_learning_rate", type=float, default=None, help="Learning rate for XGBoost. Defaults to --lr when omitted.")
    parser.add_argument("--xgb_subsample", type=float, default=1.0, help="Row subsample ratio for XGBoost.")
    parser.add_argument("--xgb_colsample_bytree", type=float, default=1.0, help="Feature subsample ratio per tree for XGBoost.")
    parser.add_argument("--xgb_reg_lambda", type=float, default=1.0, help="L2 regularization strength for XGBoost.")
    parser.add_argument("--xgb_min_child_weight", type=float, default=1.0, help="Minimum sum of instance weight in a child for XGBoost.")
    parser.add_argument("--xgb_tree_method", type=str, default="auto", help="Tree construction method for XGBoost.")
