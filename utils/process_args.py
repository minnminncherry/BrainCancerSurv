...
def _process_args():
    ...
    parser.add_argument('--pt_file_path', type=str, help='WSI image dir')
    ...
    parser.add_argument("--wsi_feature_dim", type=int, default=1024, help="Input feature dimension for WSI patch features.")
