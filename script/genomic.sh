...
MODEL="resmlp" # what type of model do you want to train? snn for model_SNNOmics.py, omics for model_Omics.py, mlp_per_path for model_MLPPerPath.py, mlp for model_MLP.py
